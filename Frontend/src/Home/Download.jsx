  ...
  return (
    <>
      ...
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 p-5">
        ...
        <div class="flex flex-wrap justify-center gap-4 text-center text-white">
          <div
            className="cursor-pointer w-full sm:w-1/3 md:w-1/4 bg-black p-10 rounded-xl opacity-90 hover:opacity-100 hover:shadow-xl hover:shadow-slate-600 dark:bg-base-100 dark:text-black"
