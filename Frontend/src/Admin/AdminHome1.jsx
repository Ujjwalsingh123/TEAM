...
const AdminHome1 = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-100 mt-[69px] dark:bg-[#222] dark:text-white">
    <div className="flex md:hidden bg-black text-white py-4 px-4 justify-start items-center">
    ...
    {/* Sidebar for desktop */}
    <div className="hidden md:flex w-64 bg-black text-white py-4 px-1 flex-col justify-between h-screen">
    ...
    {/* Mobile Sidebar */}
    <div
      className={`fixed top-[60px] w-full h-full z-50 bg-black transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 flex flex-col`}
    >
      ...
      <ul className="mt-4 space-y-4 px-4 text-white">
        <li
          ...
          onClick={() => handleMenuOptionClick("MyProfile")}
        >
          My Profile
        </li>
        <li
          className="cursor-pointer"
          onClick={() => handleMenuOptionClick("DocUploaded")}
        >
          Uploaded Documents
        </li>
        <li
          className="cursor-pointer"
          onClick={() => handleMenuOptionClick("Uploadnew")}
        >
          Upload New Document
        </li>
        <li
          className="cursor-pointer"
          onClick={() => handleMenuOptionClick("DocumentClass")}
        >
          Quick Classify
        </li>
        <li
          className="cursor-pointer"
          onClick={() => handleMenuOptionClick("DocumentSummarization")}
        >
          Quick Summarize
        </li>
      </ul>
