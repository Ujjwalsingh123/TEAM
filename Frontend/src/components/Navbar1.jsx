      ...
      >
        <div className="navbar">
          ...
          {!authUser && !authAdmin && (
            ...
            <a className="text-2xl font-bold cursor-pointer">Legal AI</a>
          </div>
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1">
              {authUser || authAdmin ? null : navItems}
            </ul>
          </div>
              ...
              authUser ? (
                <>
                  {location.pathname === "/UserHome" && (
                    <a
                      className="border border-white text-white px-3 py-2 rounded-md hover:bg-black duration-300 cursor-pointer hover:bg-slate-800 text-xs sm:text-sm px-2 py-1 sm:px-3 sm:py-2"
                      onClick={() => {
                ...
                <>
                  {location.pathname !== "/adminHome" && (
                    <Link
                      className="px-3 py-2 border  text-white rounded-md cursor-pointer hover:bg-slate-800"
                      to="/adminHome"
                    >
                      Admin Panel
                    </Link>
